...
$password = Otp::generate('samuraee@github.com');
```
...
$result = Otp::validate('samuraee@github.com', '123456');
```
...
{
    return [
        'code' => ['required', new OtpValidate('samuraee@github.com')]
    ];
}
...
<a href="https://monzo.me/aboozarghaffari" target="_blank">Buy Me A Coffee</a>
